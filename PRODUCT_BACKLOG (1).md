...
### 5. Layered Answer Architecture
**Problem:** Open-ended questions like "Tell me about yourself" get one fixed answer dumped at once. Real conversations are progressive — people want a short version first, then go deeper based on interest.
**Solution:** Three-layer answer structure:
- **Layer 1** — 3-4 line elevator pitch (who, what, where, looking for)
- **Layer 2** — career arc with key transitions and themes
- **Layer 3** — specific deep-dives (DB platform story, AI work, team leadership)

RAG detects question scope — open-ended triggers Layer 1 first, then offers to go deeper:
*"Here's a short version — [Layer 1]. Want me to walk through the full journey or jump to a specific area?"*
Follow-up questions then naturally pull the right layer out.

**What needs to be built:**
1. Index all three layers as separate KB chunks with clear labels
2. Prompt engineering — serve Layer 1 for open-ended questions, go deeper only if asked
3. Conversation memory so follow-ups build on what was already said (see item below)

**Effort:** Medium — 1-2 sessions
**Impact:** RAG becomes conversational rather than a static FAQ — much closer to how a real screening call feels
**Note:** Layers need to be authored as KB docs before this can be built
...
**Effort:** Small — 1 session
**Impact:** Makes conversation feel much more natural. Also a prerequisite for layered answers to work properly.
